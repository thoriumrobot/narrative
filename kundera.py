...
Describe the characters. Please provide three possible interpersonal events that could occur between these characters, each propelling the story forward. The events should be interpreted by each character differently because of their divergent traumas. Avoid therapy settings. The events are intended for a novel in the style of Milan Kundera.
    """
