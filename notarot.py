...
alice_readings = [
    ...
    "A Moment's Regret. Second-guessing your decisions. Berating yourself for the choices you have made. Feeling regretful and missing what was. Nostalgia ? living in the past. A focus on what is going wrong or what could still go wrong?",
    ...
    "Manage to Be Glad. Tour happiness is in your own hands ? it is something, which can be managed, nurtured and grown. Acknowledgement that life can be very difficult and challenging, but you are being asked to grow the happiness you long for, out of your magickal will and desire to feel joy once again.",
